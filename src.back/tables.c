...
SPELL_FUN *spell_function( char *name )
{
   ...
   if( !str_cmp( name, "spell_calm" ) )
      return spell_calm;
   if( !str_cmp( name, "spell_forcepush" ) )
      return spell_forcepush;
   if( !str_cmp( name, "spell_force_disarm" ) )
      return spell_force_disarm;
   if( !str_cmp( name, "spell_steal_life" ) )
      return spell_steal_life;
   ...
   switch ( name[3] )
   {
      case 'a':
         ...
         if( !str_cmp( name, "do_aassign" ) )
            return do_aassign;
         if( !str_cmp( name, "do_assignpilot" ) )
            return do_assignpilot;
      ...
      case 'b':
         ...
         if( !str_cmp( name, "do_backup" ) )
            return do_backup;
         if( !str_cmp( name, "do_battle_command" ) )
            return do_battle_command;
         if( !str_cmp( name, "do_bet" ) )
            return do_bet;
         if( !str_cmp( name, "do_bomb" ) )
            return do_bomb;
         if( !str_cmp( name, "do_buymobship" ) )
            return do_buymobship;
      ...
      case 'c':
         ...
         if( !str_cmp( name, "do_changes" ) )
            return do_changes;
         if( !str_cmp( name, "do_checkwar" ) )
            return do_checkwar;
         if( !str_cmp( name, "do_checkprints" ) )
            return do_checkprints;
         ...
         if( !str_cmp( name, "do_checkbeacons" ) )
            return do_checkbeacons;
         if( !str_cmp( name, "do_circle" ) )
            return do_circle;
         if( !str_cmp( name, "do_clans" ) )
            return do_clans;
         if( !str_cmp( name, "do_clanstat" ) )
            return do_clanstat;
         ...
         if( !str_cmp( name, "do_clanbuytroops" ) )
            return do_clanbuytroops;
         if( !str_cmp( name, "do_clansalvage" ) )
            return do_clansalvage;
         if( !str_cmp( name, "do_clangiveship" ) )
            return do_clangiveship;
         if( !str_cmp( name, "do_cleanroom" ) )
            return do_cleanroom;
         ...
         if( !str_cmp( name, "do_compare" ) )
            return do_compare;
         if( !str_cmp( name, "do_concealment" ) )
            return do_concealment;
         if( !str_cmp( name, "do_config" ) )
            return do_config;
         if( !str_cmp( name, "do_consider" ) )
            return do_consider;
         if( !str_cmp( name, "do_contract" ) )
            return do_contract;
         ...
         if( !str_cmp( name, "do_cset" ) )
            return do_cset;
         if( !str_cmp( name, "do_cut" ) )
            return do_cut;
         break;
      case 'd':
         if( !str_cmp( name, "do_demote" ) )
            return do_demote;
         if( !str_cmp( name, "do_disableship" ) )
            return do_disableship;
         if( !str_cmp( name, "do_deny" ) )
            return do_deny;
         if( !str_cmp( name, "do_description" ) )
            return do_description;
         if( !str_cmp( name, "do_describe" ) )
            return do_describe;
// if ( !str_cmp( name, "do_designship" ))      return do_designship;
         ...
         if( !str_cmp( name, "do_drop" ) )
            return do_drop;
         if( !str_cmp( name, "do_droptroops" ) )
            return do_droptroops;
         if( !str_cmp( name, "do_dualstab" ) )
            return do_dualstab;
         break;
      case 'e':
         ...
         if( !str_cmp( name, "do_endsimulator" ) )
            return do_endsimulator;
      ...
      case 'f':
         ...
         if( !str_cmp( name, "do_freeze" ) )
            return do_freeze;
         if( !str_cmp( name, "do_freeship" ) )
            return do_freeship;
         if( !str_cmp( name, "do_fslay" ) )
            return do_fslay;
         break;
      case 'g':
         if( !str_cmp( name, "do_gag" ) )
            return do_gag;
         if( !str_cmp( name, "do_gather_intelligence" ) )
            return do_gather_intelligence;
         if( !str_cmp( name, "do_gatherclans" ) )
            return do_gatherclans;
         if( !str_cmp( name, "do_get" ) )
            return do_get;
         if( !str_cmp( name, "do_gemcutting" ) )
            return do_gemcutting;
         if( !str_cmp( name, "do_generate_market" ) )
            return do_generate_market;
         if( !str_cmp( name, "do_give" ) )
            return do_give;
         if( !str_cmp( name, "do_giveship" ) )
            return do_giveship;
         if( !str_cmp( name, "do_giveslug" ) )
            return do_giveslug;
         ...
         if( !str_cmp( name, "do_goto" ) )
            return do_goto;
// if ( !str_cmp( name, "do_gotoship" ))     return do_gotoship;
      ...
      case 'i':
         ...
         if( !str_cmp( name, "do_info" ) )
            return do_info;
         if( !str_cmp( name, "do_inquire" ) )
            return do_inquire;
         if( !str_cmp( name, "do_induct" ) )
            return do_induct;
         if( !str_cmp( name, "do_installarea" ) )
            return do_installarea;
         if( !str_cmp( name, "do_installmodule" ) )
            return do_installmodule;
      ...
      case 'm':
         ...
         if( !str_cmp( name, "do_make" ) )
            return do_make;
         if( !str_cmp( name, "do_makefree" ) )
            return do_makefree;
         if( !str_cmp( name, "do_makemodule" ) )
            return do_makemodule;
         if( !str_cmp( name, "do_makecommsystem" ) )
            return do_makecommsystem;
         if( !str_cmp( name, "do_makedatapad" ) )
            return do_makedatapad;
         if( !str_cmp( name, "do_makearmor" ) )
            return do_makearmor;
         if( !str_cmp( name, "do_marry" ) )
            return do_marry;
         if( !str_cmp( name, "do_makebeacon" ) )
            return do_makebeacon;
         if( !str_cmp( name, "do_makebug" ) )
            return do_makebug;
         if( !str_cmp( name, "do_make_master" ) )
            return do_make_master;
         ...
         if( !str_cmp( name, "do_makeduallightsaber" ) )
            return do_makeduallightsaber;
         if( !str_cmp( name, "do_makespice" ) )
            return do_makespice;
         if( !str_cmp( name, "do_makegrenade" ) )
            return do_makegrenade;
         if( !str_cmp( name, "do_makeshipbomb" ) )
            return do_makeshipbomb;
         ...
         if( !str_cmp( name, "do_makeboard" ) )
            return do_makeboard;
         if( !str_cmp( name, "do_makebinders" ) )
            return do_makebinders;
         if( !str_cmp( name, "do_makegoggles" ) )
            return do_makegoggles;
         ...
         if( !str_cmp( name, "do_makeship" ) )
            return do_makeship;
         if( !str_cmp( name, "do_makeprototypeship" ) )
            return do_makeprototypeship;
         //if ( !str_cmp( name, "do_makeship2" ))           return do_makeship2;
         ...
         if( !str_cmp( name, "do_makesimulator" ) )
            return do_makesimulator;
         if( !str_cmp( name, "do_makemobship" ) )
            return do_makemobship;
      ...
      case 'n':
         ...
         if( !str_cmp( name, "do_noteroom" ) )
            return do_noteroom;
         if( !str_cmp( name, "do_nullifybeacons" ) )
            return do_nullifybeacons;
         break;
      case 'o':
...
/*	if ( !str_cmp( name, "do_opentourney" ))	return do_opentourney; */
         ...
         if( !str_cmp( name, "do_orders" ) )
            return do_orders;
         if( !str_cmp( name, "do_ordership" ) )
            return do_ordership;
         if( !str_cmp( name, "do_orderclanship" ) )
            return do_orderclanship;
      ...
      case 'p':
         ...
         if( !str_cmp( name, "do_pfiles" ) )
            return do_pfiles;
         if( !str_cmp( name, "do_plantbug" ) )
            return do_plantbug;
         if( !str_cmp( name, "do_plantbeacon" ) )
            return do_plantbeacon;
         if( !str_cmp( name, "do_propose" ) )
            return do_propose;
         if( !str_cmp( name, "do_prototypes" ) )
            return do_prototypes;
      ...
      case 'r':
         ...
         if( !str_cmp( name, "do_rembounty" ) )
            return do_rembounty;
         if( !str_cmp( name, "do_remcontract" ) )
            return do_remcontract;
         if( !str_cmp( name, "do_remclan" ) )
            return do_remclan;
         if( !str_cmp( name, "do_retune" ) )
            return do_retune;
         if( !str_cmp( name, "do_retreat" ) )
            return do_retreat;
         ...
         if( !str_cmp( name, "do_remove" ) )
            return do_remove;
         if( !str_cmp( name, "do_removebug" ) )
            return do_removebug;
         if( !str_cmp( name, "do_removemodule" ) )
            return do_removemodule;
         if( !str_cmp( name, "do_remember" ) )
            return do_remember;
         if( !str_cmp( name, "do_rempilot" ) )
            return do_rempilot;
         if( !str_cmp( name, "do_removeship" ) )
            return do_removeship;
         ...
         if( !str_cmp( name, "do_resign" ) )
            return do_resign;
         if( !str_cmp( name, "do_reward" ) )
            return do_reward;
         if( !str_cmp( name, "do_rest" ) )
            return do_rest;
         if( !str_cmp( name, "do_restore" ) )
            return do_restore;
         if( !str_cmp( name, "do_restorefile" ) )
            return do_restorefile;
      ...
      case 's':
         ...
         if( !str_cmp( name, "do_scan" ) )
            return do_scan;
         if( !str_cmp( name, "do_scanbugs" ) )
            return do_scanbugs;
         if( !str_cmp( name, "do_score" ) )
            return do_score;
         if( !str_cmp( name, "do_screenname" ) )
            return do_screenname;
         ...
         if( !str_cmp( name, "do_setinfrared" ) )
            return do_setinfrared;
         if( !str_cmp( name, "do_setplanet" ) )
            return do_setplanet;
         if( !str_cmp( name, "do_setwage" ) )
            return do_setwage;
         if( !str_cmp( name, "do_shiplist" ) )
            return do_shiplist;
         if( !str_cmp( name, "do_shipmaintenance" ) )
            return do_shipmaintenance;
         if( !str_cmp( name, "do_shiprepair" ) )
            return do_shiprepair;
         ...
         if( !str_cmp( name, "do_showclan" ) )
            return do_showclan;
         if( !str_cmp( name, "do_showcontracts" ) )
            return do_showcontracts;
         if( !str_cmp( name, "do_showbugs" ) )
            return do_showbugs;
         if( !str_cmp( name, "do_showbeacons" ) )
            return do_showbeacons;
...
// if ( !str_cmp( name, "do_setprototype" )) return do_setprototype;
         if( !str_cmp( name, "do_showship" ) )
            return do_showship;
         if( !str_cmp( name, "do_showsocial" ) )
            return do_showsocial;
         ...
         if( !str_cmp( name, "do_sit" ) )
            return do_sit;
         if( !str_cmp( name, "do_showmodules" ) )
            return do_showmodules;
         if( !str_cmp( name, "do_shiplock" ) )
            return do_shiplock;
         if( !str_cmp( name, "do_salvage" ) )
            return do_salvage;
         if( !str_cmp( name, "do_sla" ) )
            return do_sla;
         if( !str_cmp( name, "do_slicebank" ) )
            return do_slicebank;
      ...
      case 't':
         ...
         if( !str_cmp( name, "do_transship" ) )
            return do_transship;
         if( !str_cmp( name, "do_transshipss" ) )
            return do_transshipss;
      ...
      case 'u':
         if( !str_cmp( name, "do_unload" ) )
            return do_unload;
         if( !str_cmp( name, "do_unlink" ) )
            return do_unlink;
         if( !str_cmp( name, "do_unbind" ) )
            return do_unbind;
         if( !str_cmp( name, "do_ungag" ) )
            return do_ungag;
      ...
      case 'v':
         ...
         if( !str_cmp( name, "do_vassign" ) )
            return do_vassign;
         if( !str_cmp( name, "do_viewskills" ) )
            return do_viewskills;
      ...
      case 'w':
         ...
         if( !str_cmp( name, "do_who" ) )
            return do_who;
         if( !str_cmp( name, "do_whoinvis" ) )
            return do_whoinvis;
         if( !str_cmp( name, "do_wwwimage" ) )
            return do_wwwimage;
...
char *spell_name( SPELL_FUN * spell )
{
   ...
   if( spell == spell_calm )
      return "spell_calm";
   if( spell == spell_forcepush )
      return "spell_forcepush";
   if( spell == spell_force_disarm )
      return "spell_force_disarm";
   if( spell == spell_steal_life )
      return "spell_steal_life";
...
char *skill_name( DO_FUN * skill )
{
   ...
   if( skill == do_gatherclans )
      return "do_gatherclans";
   if( skill == do_generate_market )
      return "do_generate_market";
   ...
   if( skill == do_makeplanet )
      return "do_makeplanet";
   if( skill == do_makefree )
      return "do_makefree";
   if( skill == do_setinfrared )
      return "do_setinfrared";
   if( skill == do_setrank )
      return "do_setrank";
   ...
   if( skill == do_buyship )
      return "do_buyship";
   if( skill == do_buymobship )
      return "do_buymobship";
   if( skill == do_buytroops )
      return "do_buytroops";
   if( skill == do_buyhome )
      return "do_buyhome";
   ...
   if( skill == do_rembounty )
      return "do_rembounty";
   if( skill == do_remcontract )
      return "do_remcontract";
   if( skill == do_remclan )
      return "do_remclan";
   if( skill == do_shiprepair )
      return "do_shiprepair";
   ...
   if( skill == do_addsenator )
      return "do_addsenator";
   if( skill == do_remember )
      return "do_remember";
   if( skill == do_rempilot )
      return "do_rempilot";
   if( skill == do_removeship )
      return "do_removeship";
   if( skill == do_removebug )
      return "do_removebug";
   if( skill == do_removemodule )
      return "do_removemodule";
   if( skill == do_aassign )
      return "do_aassign";
   ...
   if( skill == do_channels )
      return "do_channels";
   if( skill == do_checkwar )
      return "do_checkwar";
   if( skill == do_checkprints )
      return "do_checkprints";
   if( skill == do_checkbeacons )
      return "do_checkbeacons";
   if( skill == do_chat )
      return "do_chat";
   if( skill == do_ooc )
   ...
   if( skill == do_compare )
      return "do_compare";
   if( skill == do_concealment )
      return "do_concealment";
   if( skill == do_config )
      return "do_config";
   if( skill == do_consider )
      return "do_consider";
   if( skill == do_contract )
      return "do_contract";
...
//    if ( skill == do_showprototype )     return "do_showprototype";    
   if( skill == do_showbugs )
      return "do_showbugs";
   if( skill == do_showbeacons )
      return "do_showbeacons";
   if( skill == do_destro )
      return "do_destro";
   if( skill == do_destroy )
   ...
   if( skill == do_drop )
      return "do_drop";
   if( skill == do_droptroops )
      return "do_droptroops";
   if( skill == do_dualstab )
      return "do_dualstab";
/*    if ( skill == do_diagnose )		return "do_diagnose"; */
   ...
   if( skill == do_give )
      return "do_give";
   if( skill == do_giveship )
      return "do_giveship";
   if( skill == do_giveslug )
      return "do_giveslug";
   if( skill == do_glance )
      return "do_glance";
   if( skill == do_gold )
   ...
   if( skill == do_goto )
      return "do_goto";
//    if ( skill == do_gotoship )      return "do_gotoship";
   if( skill == do_gouge )
      return "do_gouge";
   if( skill == do_group )
      return "do_group";
...
*/ if( skill == do_gtell )
   ...
   if( skill == do_makeshield )
      return "do_makeshield";
   if( skill == do_makebeacon )
      return "do_makebeacon";
   if( skill == do_makebug )
      return "do_makebug";
   if( skill == do_make_master )
      return "do_make_master";
   if( skill == do_makeblade )
      return "do_makeblade";
   if( skill == do_makeblaster )
      return "do_makeblaster";
   if( skill == do_makebinders )
      return "do_makebinders";
   if( skill == do_makegoggles )
      return "do_makegoggles";
   if( skill == do_makelightsaber )
      return "do_makelightsaber";
   if( skill == do_makeduallightsaber )
      return "do_makeduallightsaber";
   if( skill == do_makepike )
      return "do_makepike";
   ...
   if( skill == do_makeship )
      return "do_makeship";
   //if ( skill == do_makeship2 )         return "do_makeship2";
   if( skill == do_makestarsystem )
      return "do_makestarsystem";
   if( skill == do_makesimulator )
      return "do_makesimulator";
   if( skill == do_makemobship )
      return "do_makemobship";
...
/*  if ( skill == do_opentourney )	return "do_opentourney"; */
   ...
   if( skill == do_orders )
      return "do_orders";
   if( skill == do_ordership )
      return "do_ordership";
   if( skill == do_orderclanship )
      return "do_orderclanship";
   ...
   if( skill == do_pfiles )
      return "do_pfiles";
   if( skill == do_plantbug )
      return "do_plantbug";
   if( skill == do_plantbeacon )
      return "do_plantbeacon";
   if( skill == do_propose )
      return "do_propose";
   if( skill == do_pardon )
   ...
   if( skill == do_scan )
      return "do_scan";
   if( skill == do_scanbugs )
      return "do_scanbugs";
   if( skill == do_score )
      return "do_score";
   if( skill == do_screenname )
      return "do_screenname";
   if( skill == do_scribe )
      return "do_scribe";
   if( skill == do_search )
   ...
   if( skill == do_setstarsystem )
      return "do_setstarsystem";
   if( skill == do_shiplist )
      return "do_shiplist";
   if( skill == do_shipmaintenance )
      return "do_shipmaintenance";
   if( skill == do_ships )
      return "do_ships";
   if( skill == do_shops )
   ...
   if( skill == do_showclan )
      return "do_showclan";
   if( skill == do_showcontracts )
      return "do_showcontracts";
   if( skill == do_showship )
      return "do_showship";
   if( skill == do_showplanet )
      return "do_showplanet";
   if( skill == do_showsocial )
      return "do_showsocial";
   ...
   if( skill == do_sit )
      return "do_sit";
   if( skill == do_showmodules )
      return "do_showmodules";
   if( skill == do_shiplock )
      return "do_shiplock";
   if( skill == do_salvage )
      return "do_salvage";
   if( skill == do_sla )
   ...
   if( skill == do_tell )
      return "do_tell";
   if( skill == do_tellsnoop )
      return "do_tellsnoop";
   if( skill == do_makecommsystem )
      return "do_makecommsystem";
   if( skill == do_makedatapad )
      return "do_makedatapad";
   if( skill == do_codecrack )
      return "do_codecrack";
   if( skill == do_disableship )
      return "do_disableship";
   if( skill == do_assignpilot )
      return "do_assignpilot";
   if( skill == do_time )
      return "do_time";
   if( skill == do_tune )
