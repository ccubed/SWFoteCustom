...
#define RACE_FIRRERREO         21
#define RACE_BARABEL           22
#define RACE_BOTHAN            23
#define RACE_TOGORIAN          24
#define RACE_DUG               25
#define RACE_KUBAZ             26
#define RACE_SELONIAN          27
#define RACE_GRAN              28
#define RACE_YEVETHA           29
#define RACE_GAND              30
#define RACE_DUROS             31
#define RACE_COYNITE           32
#define RACE_SULLUSTAN         33
...
#define RACE_INDUSTRY_DROID 39
#define RACE_HUNTER_DROID 40
#define RACE_INTERFACE_DROID 41
...
typedef enum
{
   ...
   ITEM_PULLCHAIN, ITEM_BUTTON, ITEM_DIAL, ITEM_DEED, ITEM_RUNEPOUCH,
...
struct obj_data
{
   ...
   /* Begin engineering bonus material data */
   int power_cap;/* Max Capacity Batteries can Provide */
   int armor_rating;/* Max addition to AC when used for Armor */
};
...
/*
 * Struture to hold race ability bonus data
 * Ordered by the Constant declared in const.c
 * - Gizmo
 */
struct ability_bonus
{
...
/*
 * Structure to hold companion classes
 */
struct companion_classes{
