...
#define LEVEL_NEOPHYTE		   (MAX_LEVEL - 205)
#define LEVEL_AVATAR		   (MAX_LEVEL - 6)
...
typedef enum
{
  ...
  ITEM_RLAUNCHER, ITEM_BINDERS, ITEM_GOGGLES, ITEM_SHIPBOMB, ITEM_EMP_GRENADE, ITEM_BLANK_CIRCUIT, ITEM_CRYSTAL,
  ITEM_GEM, ITEM_SILICONGEL
} item_types;


#define MAX_ITEM_TYPE		     ITEM_SILICONGEL
/*
 * Extra flags.
 * Used in #OBJECTS.
 */
